public class Words {
	public static void main(String[] args) {
		...
		// == when used with references(objects) if they are pointing to the object
		System.out.println(str == str1); // true. It means they point to the same object ( String pool )
